    ...
    var body: some View {
        ...
        NavigationStack {
            List {
                ...
                RunnerPageHeader(eyebrow: "Manage people", title: "People", count: contacts.count)
                    .crmListBlock(top: Runner.Spacing.small)

                RunnerSearchField(placeholder: "Search people", text: $searchText)
                    .crmListBlock(bottom: Runner.Spacing.snug)
                ...
                .crmListRow(insets: EdgeInsets(top: 0, leading: 0, bottom: Runner.Spacing.small, trailing: 0), separator: .hidden)

                RunnerSectionLabel(selectedTab.sectionTitle)
                    .crmListBlock(top: Runner.Spacing.small, bottom: Runner.Spacing.xsmall)
