...
enum TodayViewCopy {
    ...
    static let emptyFocusTitle = "Clear for now"
    static let emptyFocusDescription = "No decision, deadline, or relationship follow-up needs action today. Maraithon will surface the next concrete move when one appears."
