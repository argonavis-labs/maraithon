...
enum TodayViewCopy {
    ...
    static let emptyFocusTitle = "Saved context is clear"
    static let emptyFocusDescription = "No saved decision, deadline, or relationship follow-up is waiting in this view. Maraithon will surface the next concrete move when one appears."
