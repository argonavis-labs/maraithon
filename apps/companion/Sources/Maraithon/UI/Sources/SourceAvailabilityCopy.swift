...
enum SourceAvailabilityCopy {
    ...
    static let unavailableDescription = "Choose a supported source from the sidebar to view assistant context and recent checks. This source is not available yet."
