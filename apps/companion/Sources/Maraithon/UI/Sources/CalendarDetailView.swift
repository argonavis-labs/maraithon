...
/// Detail pane for the Calendar Events source. Activity and recent checks
...
struct CalendarDetailView: View {
    ...
    private var stats: [SourceStat] {
        let pub = publisher
        return [
            SourceStat(id: "today", title: "Today", value: SourceStat.format(pub?.acceptedToday), caption: "events added"),
