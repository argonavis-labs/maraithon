defmodule MaraithonWeb.ConnectorsHTMLTest do
  ...
  test "connection helper labels use product copy" do
    ...
    assert ConnectorsHTML.setup_completion_text(%{}) == "Connection needs attention"
    ...
    assert ConnectorsHTML.connection_status_label(:not_configured) == "not ready"
    ...
    assert ConnectorsHTML.setup_status_label(:configured) == "ready"
    assert ConnectorsHTML.setup_status_label(:incomplete) == "needs attention"
    assert ConnectorsHTML.setup_status_label(:unexpected) == "not checked"
