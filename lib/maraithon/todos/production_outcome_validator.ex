defmodule Maraithon.Todos.ProductionOutcomeValidator do
  ...
  defp processing_error_category(event, job) do
    ...
    cond do
      ...
      String.contains?(error, "runtime_authority_not_ready") -> "runtime_authority_not_ready"
      String.contains?(error, "task_authority_lost") -> "task_authority_lost"
      String.contains?(error, "claim_lost") -> "claim_lost"
      String.contains?(error, "job_task_result_missing") -> "task_result_missing"
      String.contains?(error, "persistence_deferred") -> "persistence_deferred"
      String.contains?(error, "missing_string_payload") -> "missing_payload"
      String.contains?(error, "invalid_todo_learning_event_id") -> "invalid_event_id"
      String.contains?(error, "todo_learning_event_not_found") -> "event_not_found"
      String.contains?(error, "privacy_erasure_requested") -> "privacy_erasure"
      String.contains?(error, "user_not_found") -> "user_not_found"
      String.contains?(error, "background_job_error") -> "background_job_error"
