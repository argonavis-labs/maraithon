defmodule Maraithon.Runtime.RuntimeIncident do
  ...
  @kinds ~w(node_boot node_shutdown agent_crash agent_resumed agent_stopped_unexpectedly agent_termination_unproven db_outage db_recovered stuck_state_detected stuck_state_swept)
